...
urls=["https://www.thestar.com/news/canada.html"]
name_list=[]
price_list=[]
price_match_list=[]
namee_list=[]
...
for i in range(len(urls)):
    ...
    title_name=soup.find_all('div',class_='c-mediacard__content')
    source_name=soup.find_all('div',class_='metadataText')
    posted_date=soup.find_all('div',class_='c-mediacard-footer')
    news=soup.find_all('div',class_='c-feature-mediacard__headlines')
    # Title Name list
    for i in title_name:
        h3=i.find('h3')
        if h3 is not None:
